import { validateVehicleSpec, type VehicleSpec } from "./content/vehicle-spec";
export type { VehicleSpec } from "./content/vehicle-spec";
...
export const QUADRO_SPEC = validateVehicleSpec(quadroSpec.vehicle);
export const BUGGY_SPEC = validateVehicleSpec(buggySpec.vehicle);
...
export function vehicleForTrack(
  trackId: TrackId,
  requested: VehicleId,
): VehicleId {
